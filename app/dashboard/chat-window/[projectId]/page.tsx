        ...
        <div className="flex flex-col h-screen bg-gray-50">
            ...
            <div className="flex items-center p-4 bg-white border-b shadow-sm">
                ...
                <h2 className="text-xl font-semibold flex-grow">
                    Project Chat: {projectId ? projectId.substring(0, 8) : 'Loading'}...
                </h2>
            ...
            {/* Messages container */}
            <div ref={chatContainerRef} className="flex-grow overflow-y-auto p-4" onScroll={handleScroll}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <div className={`font-bold ${isCurrentUser && 'hidden'}`}>
                                                        {userName}
                                                    </div>
                                                    {msg.content}
                                                </div>
